...
function reconstructed_image = TDPG_ED1 (Y, Phi1, Phi2,  RBI_matrix, Index, num_rows, num_cols, num_levels)
...
function [X, D] = SPLIterationBivariate(Y, X, Phi1, Phi2, pinvPhi1, pinvPhi2, NPT_model, Index, num_rows, num_cols, lambda, num_levels,chaoticList,rules)
